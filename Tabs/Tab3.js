...
imageToTensor(rawImageData) {
  ...
  classifyImage = async () => {
    try {
      ...
      console.log('File Path', imageAssetPath)
     // RNFetchBlob.fs.readFile(imageAssetPath.uri, 'base64').then((data) => {
        // handle the data ..
     ...
     // const response = await fetch('https://media.vanityfair.com/photos/5ef25d9d184617200a49bac5/4:3/w_2999,h_2249,c_limit/M8DBATM_WB002.jpg', {}, { isBinary: true })
